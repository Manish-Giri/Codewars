...
"0 -> 1 -> 4 -> 9 -> 16 -> null"
Note that null/NULL/None itself is also considered a valid linked list. In that case, its string representation would simply be "null"/"NULL"/"None" (again, depending on the language).
